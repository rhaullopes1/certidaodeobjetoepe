...
export const TJSP_URL = `${SITE}/certidao-de-objeto-e-pe/sp`;
const URL = TJSP_URL;
const TITLE = "Certidão de Objeto e Pé TJSP (SP): Como Solicitar Online";
const DESC =
  "Como pedir a Certidão de Objeto e Pé de processos do TJSP, em qualquer comarca de São Paulo: dados necessários, e-SAJ, processos físicos e acompanhamento do pedido.";
...
const FAQ_TJSP: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Sim. O documento é emitido pelo próprio Tribunal de Justiça de São Paulo, e tem validade em todo o território nacional.",
  },
  {
  ...
  {
    q: "Processos criminais e cíveis do TJSP também têm certidão?",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "São Paulo (TJSP)", item: URL },
          ],
        }),
      },
    ],
        ...
        <section className="px-5 py-16 sm:px-8 lg:py-24">
          <div className="mx-auto w-full max-w-6xl">
            <nav aria-label="Trilha" className="text-xs text-muted-foreground">
              ...
              <span className="px-2">/</span>
              <span className="font-semibold text-foreground">São Paulo (TJSP)</span>
            </nav>
            ...
            <h1 className="mt-4 max-w-3xl font-display text-3xl font-bold leading-tight sm:text-5xl">
              Certidão de Objeto e Pé no TJSP (São Paulo)
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
              A Certidão de Objeto e Pé é emitida pelo Tribunal de Justiça de São Paulo (TJSP). Não somos
              órgão público: fazemos o pedido ao tribunal por você, em qualquer foro da capital ou do
              interior, e acompanhamos até a emissão. Você só informa o número do processo.
            </p>
