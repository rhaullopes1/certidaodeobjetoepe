...
const URL = `${SITE}/certidao-objeto-e-pe-tjpe`;
        ...
        <section className="px-5 py-16 sm:px-8 lg:py-24">
          <div className="mx-auto w-full max-w-6xl">
            ...
            <h1 className="mt-4 max-w-3xl font-display text-3xl font-bold leading-tight sm:text-5xl">
              Certidão de Objeto e Pé TJPE: como solicitar online no Tribunal de Justiça de
              Pernambuco
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
              Emitimos a Certidão de Objeto e Pé de processos que tramitam no TJPE, em qualquer
              comarca de Pernambuco. Você informa o número do processo e nossa equipe cuida do
              requerimento no PJe — ou no cartório da vara, quando o processo é físico — até a
